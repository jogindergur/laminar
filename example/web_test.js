...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var parts = A._setArrayType([new Uint8Array(A._ensureNativeList(A._setArrayType([1, 2, 3, 4], type$.JSArray_int)))], type$.JSArray_Object);
      A.printString("Blob size: " + A._asInt(type$.JSObject._as(new init.G.Blob(parts, {type: "video/mp4"})).size));
    }
  },
  B = {};
  var holders = [A, J, B];
