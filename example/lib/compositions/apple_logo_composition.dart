        ...
        Container(
          decoration: BoxDecoration(
            gradient: RadialGradient(
              ...
              radius: 1.4,
              colors: [HSLColor.fromAHSL(1, bgHue, 0.50, 0.08).toColor(), const Color(0xFF000000)],
            ),
          ),
        ),
...
class _AppleLogoPainter extends CustomPainter {
  ...
  Path _buildPath(double w, double h) {
    ...
    path.cubicTo(x(782.30), y(345.40), x(679.90), y(403.10), x(679.90), y(531.40));
    path.cubicTo(x(679.90), y(679.80), x(810.20), y(732.30), x(814.10), y(733.60));
    path.cubicTo(x(813.50), y(736.80), x(793.40), y(805.50), x(745.40), y(875.50));
    path.cubicTo(x(702.60), y(937.10), x(657.90), y(998.60), x(589.90), y(998.60));
    path.cubicTo(x(521.90), y(998.60), x(504.40), y(959.10), x(425.90), y(959.10));
    path.cubicTo(x(349.40), y(959.10), x(322.20), y(999.90), x(260.00), y(999.90));
    path.cubicTo(x(197.80), y(999.90), x(154.40), y(942.90), x(104.50), y(872.90));
    path.cubicTo(x(46.70), y(790.70), x(0.00), y(663.00), x(0.00), y(541.80));
    path.cubicTo(x(0.00), y(347.40), x(126.40), y(244.30), x(250.80), y(244.30));
    path.cubicTo(x(316.90), y(244.30), x(372.00), y(287.70), x(413.50), y(287.70));
    path.cubicTo(x(453.00), y(287.70), x(514.60), y(241.70), x(589.80), y(241.70));
    path.cubicTo(x(618.30), y(241.70), x(720.70), y(244.30), x(788.10), y(340.90));
    path.close();

    // Leaf
    path.moveTo(x(554.10), y(159.40));
    path.cubicTo(x(585.20), y(122.50), x(607.20), y(71.30), x(607.20), y(20.10));
    ...
    path.cubicTo(x(429.70), y(108.20), x(403.10), y(159.40), x(403.10), y(211.30));
    path.cubicTo(x(403.10), y(219.10), x(404.40), y(226.90), x(405.00), y(229.40));
    path.cubicTo(x(408.20), y(230.00), x(413.40), y(230.70), x(418.60), y(230.70));
    path.cubicTo(x(464.00), y(230.70), x(521.10), y(200.30), x(554.10), y(159.40));
    path.close();
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Glow
    final glowColor = HSLColor.fromAHSL(0.55 * opacity, h1, 1.0, 0.58).toColor();
  ...
  bool shouldRepaint(_AppleLogoPainter old) =>
      old.shimmerHue != shimmerHue || old.glowRadius != glowRadius || old.opacity != opacity;
}
...
class _StarfieldPainter extends CustomPainter {
  ...
  static final _stars = List.generate(80, (i) {
    ...
    return (x: r.nextDouble(), y: r.nextDouble(), rad: 0.4 + r.nextDouble() * 1.1, spd: 0.3 + r.nextDouble() * 0.7);
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final s in _stars) {
      final tw = 0.25 + 0.75 * ((math.sin(t * s.spd * math.pi * 4 + s.x * 10) + 1) / 2);
